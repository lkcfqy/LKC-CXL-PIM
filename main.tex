...
\begin{figure}[t]
\centerline{\includegraphics[width=\columnwidth]{paper_assets/figures/fig8_inlu_schematic.pdf}}
...
\begin{figure}[t]
\centerline{\includegraphics[width=\columnwidth]{paper_assets/figures/fig9_outlier_schematic.pdf}}
...
\midrule
2K  & Baseline & 118,861,016 & 51,432,352 & 250,266 \\
2K  & LKC-CXL-PIM & \textbf{1,203,816} & \textbf{475,436} & \textbf{3,913} \\
\midrule
8K  & Baseline & 47,544,296 & 20,518,496 & 111,978 \\
8K  & LKC-CXL-PIM & \textbf{485,665} & \textbf{212,531} & \textbf{1,639} \\
\bottomrule
\end{tabular}%
}
...
Deeper cycle-accurate Ramulator data (Table~\ref{tab:sim_results} and Fig.~\ref{fig:ramulator}) reveals the architectural catalyst for this acceleration. By shifting from standard Host-driven fetches to in-memory grouped broadcasts, generation total read latency cycles are suppressed by $\sim98.9\%$ (e.g., from 47.5 million cycles down to 485 thousand cycles). Crucially, localized bank scheduling practically eliminates DRAM row-buffer ping-ponging, suppressing Row Misses from 111,978 down to barely 1,639 for the 8K trace.
