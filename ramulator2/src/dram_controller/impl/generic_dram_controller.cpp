...
class GenericDRAMController final : public IDRAMController, public Implementation {
  ...
  public:
    ...
    void setup(IFrontEnd* frontend, IMemorySystem* memory_system) override {
      std::cout << "[GenericDRAMController] Setup starting for channel " << m_channel_id << "..." << std::endl;
    ...
    bool send(Request& req) override {
      ...
      switch (req.type_id) {
        ...
        case Request::Type::KVCacheRead: {
          s_num_read_reqs++;
          break;
        }
        case Request::Type::Write:
        case Request::Type::KVCacheWrite: {
          s_num_write_reqs++;
          break;
        }
        default: {
      ...
      if (req.type_id == Request::Type::Read || req.type_id == Request::Type::KVCacheRead) {
      ...
      } else if (req.type_id == Request::Type::Write || req.type_id == Request::Type::KVCacheWrite) {
        // KVCacheWrite goes to write buffer, plugins will modify it
    ...
    void tick() override {
      ...
      if (request_found) {
        ...
        if (req_it->command == req_it->final_command) {
          if (req_it->type_id == Request::Type::Read || req_it->type_id == Request::Type::KVCacheRead) {
            req_it->depart = m_clk + m_dram->m_read_latency;
            pending.push_back(*req_it);
          } else if (req_it->type_id == Request::Type::Write || req_it->type_id == Request::Type::KVCacheWrite) {
